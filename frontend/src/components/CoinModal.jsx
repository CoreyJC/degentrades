              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
                    ...
                    {user ? (
                      <>
                        <div className="text-xs text-gray-500 mb-2">Balance: {portfolio?.solBalance.toFixed(4) ?? '—'} SOL</div>
                    ...
                    <input type="number" min="0" step="any" placeholder="SOL amount"
                      value={solAmt} onChange={(e) => setSolAmt(e.target.value)}
                    ...
                    >{user ? 'Buy' : '🔒 Sign in to Buy'}</button>
                  </div>
                  ...
                  <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
                    ...
                    {user && holding ? (
                      <>
                        <div className="text-xs text-gray-500 mb-1">Holding: {holding.amount.toExponential(3)} {coin.ticker}</div>
                    ...
                    <input type="number" min="0" step="any" placeholder={`${coin.ticker} amount`}
                    ...
                    <button onClick={sell} disabled={busy || (user && !holding)}
                    ...
                    >{user ? 'Sell' : '🔒 Sign in to Sell'}</button>
                  </div>
                </div>
              </>
            ) : null}
